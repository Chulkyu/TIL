...
* 명사, 형용사와 같이 쓰이는 sein 동사
```

 Ich bin Kyu.	/	Du bist Kyu.	/	Er ist Kyu.	/	Sie ist Carla.

Es ist Kyu.	/	Wir sind Studenten	/	Ihr seid Studentinnen

Sie sind Studenten



Ich bin stark	/	Du bist schwach	/	Er ist jung	/ Sie ist alt

Es ist alt	/	Es ist neu	/	Wir sind jung	/	Ihr seid jung
...
Er lernt Koreanisch	/	Sie lernt Koreanisch

Wir lernen Englisch	/ Ihr lernt Japanisch

Sie lernen Koreanisch	/	Sie lernen Englisch

```
* 주어 + wohnen + in 도시
```

Ich wohne in Seoul	/	Du wohnst in Seoul

Er wohnt in Berlin	/	Sie wohnt auch in Berlin

Wir wohnen in Bonn	/	Ihr wohnt auch in Bonn
...
Ich komme aus Deutschland	/	Du kommst aus Deutschland

Er kommt aus Korea	/	Sie kommt auch aus Korea

Wir kommen aus Frankreich	/	Ihr kommt aus Frankreich
...
< 주어 + fahren + nach(국가, 도시) 장소
Ich fahre nach Switzerland
Du fährst nach Korea
Er fährt nach Zurich
```
...
```
< 남성 >
* 계절(im), 월(im), 요일(am), 시간(am)
Frühling, Sommer, Herbst, Winter

* 날씨, 방위
 날씨 - Regen, Schnee, Hagel(우박)...
 방위 - Nordwest(en), Süd(en)...

* 술 이름
 Cognac, Wein, Whiskey...
 
* 특수한 어미를 지닌 명사들 ( -er, -ismus)
# 동사에서 파생됨
 Faher	/	Arbeiter	/	Kapitalismus	/	Journalismus
```

```
< 여성 > 
* 특수한 어미를 지닌 명사들
 ( -heit, -keit, -ung, -ion, -schaft)
 Gesundheit	/	Krankheit
 Situation	/	Station
 Fähigkeit(능력)	/	Schwierigkeit(어려움)
 Übung(연습)	/	Zeitung
 Mannschaft(팀)	/	Freundschaft
...
네 어머니도 선생님입니다.
-> Deine Mutter ist auch Lehrerin

그의 남동생은 의사입니다.
-> Sein Bruder ist Arzt
그녀의 여동생도 의사입니다.
-> Ihre Schwester ist auch Ärztin
...
-> Unser Auto ist blau
너희의 차들은 노랗다.
-> Eure Autos sind gelb

그녀(그들, 당신)의 책들은 흥미롭다.
-> Ihre Bücher sind interessant

이 자동차는 내 어머니 마음에 든다.
-> Das Auto gefällt meiner Mutter
이 집은 너의 아버지 마음에 든다.
-> Das Haus gefällt deinem Vater

한 남자가 그의 아내를 돕는다.
-> Ein Mann hilft seiner Frau
한 여자가 그녀의 남편을 돕는다.
-> Eine Frau hilft ihrem Mann

그 가방은 우리 어머니 마음에 든다.
-> Die Tasche gefällt unserer Mutter
그건 너희 여동생 마음에도 든다.
-> Sie gefällt auch eurer Schwester
그 자동차는 내 부인 거다.
...
그는 너의 여동생들을 부른다.
-> Er ruft deine Schwestern

한 여자가 그녀의 형제에게 질문했다.
-> Eine Frau fragt ihren Bruder
한 남자가 그의 형제들에게 질문했다.
-> Ein Mann fragt seine Brüder

우리는 우리의 집을 본다.
-> Wir sehen unser Haus
너희는 너희의 집들을 본다.
-> Ihr seht eure Häuser

그 여선생님은 그녀의 학생들에게 질문한다.
-> Die Lehrerin fragt ihre Schüler
그 여선생님은 당신의 학생들에게 질문한다.
-> Die Lehrerin fragt Ihre Schüler

+ 소유관사 2격(주어 뒤에서 꾸며준다.)
내 아이의 친구들이 자신의 선생님에게 질문한다.
-> Die Freunde meines Kindes fragen ihren Lehrer
...
Fährst du nach Berlin?	/	 Fahren Sie nach Berlin?
Fliegen Sie nach Berlin?	/	 Fliegt sie nach Deutschland?
Fliegt ihr nach Deutschland?	/	 Fliegst du nach Berlin?
```

```
Hast du kein Geld?	/	 Doch, ich habe viel Geld
Liebst du mich nicht?	/	 Doch, ich liebe dich
Kaufen Sie keine Tasche?	/	 Nein, ich kaufe keine Tasche
Kommen Sie nicht aus Korea?	/	 Nein, ich Komme nicht aus Korea
```



### Lektion 10. 의문문 ( 의 + 동 + 주 )
...
```
Wohin fährt sie?	/	 Wo fährt sie hin?
Wo wohnst du?

Wo ist mein Auto?	/	 Wo steht mein Auto?
Dein Auto ist da	/	 Dein Auto steht da

Wo ist mein Buch?	/	Wo liegt mein Buch?
Ich habe keine Ahnung

Wohhin fliegen Sie?	/	 Wohin fahren Sie?
Ich fliege in die Schweiz

저 차는 어디로 가나요?
Wohin fährt das Auto?
저 차는 베를린으로 가요.
Das Auto fährt nach Berlin.
...
Woher kommt der Zug?
그 기차는 부산에서 왔어.
Der Zug kommt aus Busan
```



### Lektion 11. 의문문 ( Wer, Wie Was )

```
저 남자는 누구에요?
- Wer ist der Mann?
저 남자는 철규씨에요.
- Der Mann ist Herr Kim
...
누가 프라이부르크에 살아요?
- Wer wohnt in Freiburg?
철규씨가 프라이부르크에 살아요.
- Kyu wohnt in Freiburg

누가 너희를 도와줘?
- Wer hilft euch?
막스와 레나가 우리를 도와줘.
- Max und Lena helfen uns

누가 독일로 가요?
- Wer fliegt nach Deutschland?
아무도 거기로 안가요.
- Niemand fliegt *danach*
```
...
- Wie viel kostet das?
이거 삼십오 유로에요.
- Es kostet fünfunddreißig Euro.

이거 얼마에요?
- Wie teuer ist das?
이거 삼심오 유로에요.
- Das ist fünfunddreißig Euro.
...
제 취미는 음악듣기와 자전거타기입니다.
- Meine Hobbys sind Musik hören und Rad fahren.

너 지금 뭐 먹어?
- Was isst du *jetzt*?
나 지금 치즈빵 먹어.
- Ich esse jetzt ein Käsebrot
...
Nein, es ist sehr langweilig

그녀는 예쁜가요?
Ist sie hübsch?
아뇨, 그녀는 못생겼습니다.
Nein, sie ist hässlich.

너의 형제는 부지런하니?
Ist dein Bruder fleißig?
아뇨, 그는 매우 게으릅니다.
Nein, er ist sehr faul.

그 자전거는 새 것인가요?
Ist das Fahrrad neu?
아뇨, 그건 이미 매우 오래되었어요.
Nein, es ist schon sehr alt.

독일에 오래 머무르세요?
Bleiben Sie lange in Deutschland?
아뇨, (거기에) 단지 짧게만 머무릅니다.
Nein, da bleibe ich nur kurz.

저 자동차는 빨리 달리나요?
Fährt das Auto schnell?
아뇨, 그것은 천천히 달립니다.
Nein, es fährt langsam.

당신의 자동차는 비싼가요?
Ist Ihr Auto teuer?
네, 제 자동차가 조금 비쌉니다.
Ja, mein Auto ist ein bisschen teuer

**도대체** 얼마나 비싼데요?
Wie teuer ist es denn?
2백만 유료입니다.
Es kostet zwei Millionen Euro.

도대체 얼마나 오래되었는데요?
Wie alt ist es denn?
8년 되었어요.
Es ist **schon** acht Jahre alt.

대체 얼마나 머무르세요?
Wie lange bleiben Sie denn da?
단지 2주일이요.
Ich bleibe nur zwei Wochen.
Da bleibe ich nur zwei Wochen.
```
...
어느 탁자가 마음에 드십니까?
Welcher Tisch gefällt Ihnen?
저게 제 마음에 듭니다.
Der da (gefällt mir gut).

어느 탁자를 사십니까?
Welchen Tisch kaufen Sie?
바로 이걸 삽니다.
Ich kaufe **diesen**.

어느 가방을 원하니?
Welche Tasche möchtest du?
바로 이 가방을 원해요.
Ich möchte genau diese.
...
어느 방이 어둡니?
Welches Zimmer ist dunkel?
저 침실이 어두워.
Das Schlafzimmer (da) ist dunkel

어느 기차가 지금 오고 있니?
Welcher Zug kommt jetzt?
퀼른에서 출발한 기차가 오고 있어.
Der Zug **aus** Köln kommt jetzt.

어느 기차를 타니?
Welchen Zug nimmst du?
나는 이 도시 고속전철을 탈 거야.
Ich nehme diese S-Bahn.

어느 그림들이 쌉니까?
Wechle Bilder sind billig?
이 그림들이 매우 쌉니다.
Diese Bilder sind sehr billig.

이 의자는 어느 색깔을 지니고 있죠?
Welche Farbe hat der Stuhl?
저 의자는 진한 갈색이다.
Dieser Stuhl ist dunkelbraun.
```
...
- das Kleid + der Schrank
 = der Kleiderschrank : 옷장
 Der Kleiderschrank ist groß und teuer.
 
- der Schrank + der Schlüssel
 = der Schrankschlüssel : 장롱열쇠
 Wo ist mein Schrankschlüssel?
 
- die Geburt + der Tag
 = der Geburtstag : 생일
 Ich habe am 13. Dezember Geburtstag.
 
- die Geburt + s + das Haus
 = Geburtshaus : 생가
 
- der Geburtstag + s + Geschenk
 = das Geburtstagsgeschenk : 생일선물
 
- die Schule + die Tasche
 = die Schultasche : 책가방
 Meine Schultasche ist im Schrank.
 
- die Hose + n + die Tasche
 = die Hosentasche : 주머니
 
- die Hosentasche + n + das Geld
 = das Taschengeld : 용돈
 
 
그 소녀는 이미 유치원에 다녀요.
Das Mädchen geht schon in **den** Kindergarten.

그 유모차는 현관문 앞에 서 있어요.
Der Kinderwagen steht vor der Haustür.

그 소아과 의사는 매우 친절해요.
Der Kinderarzt ist sehr nett.

내 주치의는 매우 친절해요.
Mein Hausarzt ist sehr nett.

그 아동도서는 매우 흥미롭다.
Das Kinerbuch ist sehr interessant.

그 아동도서는 매우 지루하다.
Das Kinderbuch ist sehr langweilig.

```

```
- Wörter + das Buch 
 = das Wörterbuch : 사전	/	 die Wörterbücher
...
- die Schokolade + der Kuchen
 = der Schokoladenkuchen : 초코케잌
 
- das Telefon + die Nummer
 = die Telefonnummer : 전화번호	/	 die Telefonnummern
 
- die Wand + die Uhr
 = die Wanduhr : 벽시계	/	 die Wanduhren
 
- der Computer + der Tisch
 = der Computertisch : 컴퓨터 책상
...
- der Apfel + der Baum
 = der Apfelbaum : 사과나무	/	 die Apfelbäume
 
 일요일에 난 집에 있다.
 Am Sonntag bin ich zu Haus.
 
 여름엔 많은 사람들이 선글라스를 착용한다.
 Im Sommer tragen viele Menschen Sonnenbrillen.
...
- sprechen + die Stunde
 = die Sprechstunde : 면담시간
진찰시간은 20분 뒤에 비로소 시작된다.
Die Sprechstunde beginnt erst in 20 Minuten.
...
- waschen + das Mittel
 = das Waschenmittel : 세제
 
- einkaufen + der Korb
 = der Einkaufenkorb : 장바구니
 
- wandern + die Schuhe
 = die Wandersdchuhe : 등산화
...
- schreiben + der Tisch
 = der Schreibtisch : 책상
 = die Schreibtischlampe : 스탠드전등
 
- lesen + die Brille
 = die Lesebrille : 독서형 안경
...
```
- 대화의 상황에 따라 내용을 도와주는 동사
- 때로는 본동사로도 쓰임
- 현재형에서 1,3인칭 단수가 같음
- 본동사 동사원형으로 (거의) 문장의 뒤에 위치
- 주어 + 동사 + 목적어
 -> 주어 + 화법조동사 + 목적어 + 본동사
```
...
Eva가 그녀의 아버지를 방문하다.
 : Eva besucht ihren Vater.
 
Eva는 그녀의 아버지를 방문할 것이다.
 : Eva will ihren Vater besuchen.
```
...
당신은 독일어로 아주 잘 말하시나요?
 : Können Sie sehr gut Deutsch sprechen?
 
당신은 축구를 잘 하시나요?
 : Können Sie gut Fußball spielen?
 
그(여인은) 춤을 잘 출 수 있나요?
 : Kann die Frau gut tanzen?
 
아뇨, 그녀는 그리 잘 춤추지 못해요.
 : Nein, sie kann nicht so gut tanzen.
 
(저)아이는 기타를 잘 쳐요?
 : Kann das Kind gut Guitarre spielen?
 
네, (저)아이는 기타를 정말 잘 연주해요.
 : Ja, es kann wirklich toll Guitarre spielen.
 
저 좀 도와주실 수 있나요?
 : Können Sie mir bitte helfen?
 
네, 기꺼이 도와드릴 수 있어요.
 : Ja, ich kann Ihnen gerne helfen.
 
창문 좀 열어줄 수 있어?
 : Kannst du das Fenster aufmachen?
 
응, 열 수 있어.
 : Ja, ich kann es aufmachen.
 
여기서 좋은 가구들을 살 수 있나요?
 : Kann man hier gute Möbel kaufen?
...
나는 오늘 그를 방문할 수 없다.
 : Ich kann ihn heute nicht besuchen.
...
저는 토요일에 이사할 것입니다.
 : Ich will am Samstag umziehen.
 
당신은 올해 무엇을 하실 건가요?
 : Was wollen Sie dieses Jahr machen?
 
저 올해 독일어를 공부할 거에요?
 : Ich will dieses Jahr Deutsch studieren.

그 케이크 먹을 거야?
 : Willst du den Kuchen essen?
 
아니, 나 그 케이크 안 먹을 거야.
 : Nein, Ich will ihn nicht essen.
...
당신도 알고 싶으세요?
 : Möchten Sie auch wissen?
 
전 독일에서 공부하고 싶어요.
 : Ich möchte in Deutschland studieren.

너도 독일에서 공부하고 싶니?
 : Möchtest du auch in Deutschland studieren?
 
전 카페라떼 한 잔 마시고 싶어요.
 : Ich möchte eine Tasse Milchkaffee trinken.
 
당신은 뭐 마실래요?
 : Was möchten Sie trinken?

너 오늘 서울 가고 싶어?
 : Möchtest du heute nach Seoul fahren?
 
아니, 난 내일 가고 싶어.
 : Nein, ich möchte morgen nach Seoul fahren.
...
그래, 너희는 영화를 보러 가도 괜찮아.
 : Ja, ihr dürft ins Kino gehen.

dürfen + nicht = ~ 하면 안된다. ( 금지 : das Verbot )
...
(사람들은) 여기서 석쇠구이를 해도 되나요?
 : Darf man hier grillen?

```

```
sollen : 충고, 추천, 도덕적 의무, 소문, 제3자의 의지...

당신은 그렇게 많이 술 드시면 안 되요.
 : Sie sollen nicht so viel trinken.
...
언제 차를 고쳐야 할까?
 : Wann soll ich mein Auto reparieren?

의사 쌤이 나보고 더 많이 자랬어! (제3자의 의지)
 : Der Arzt hat gesagt, ich soll mehr schlafen.
 
자신의 부모를 공경해야 한다. (도덕적 의무)
...
여기 도사관에선 조용하셔야 해요.
 : Man muss hier in der Bibliothek leise sein.

나는 약을 복용해야 해.
 : Ich muss die Medikamente nehmen.
 
müssen + nicht = ~ 할 필요가 없다.

그녀는 내일 일 할 필요가 없다.
 : Sie muss morgen nicht arbeiten.

그는 요리할 필요가 없다.
 : Er muss nicht kochen.

나는 내일 학교 갈 필요가 없다.
 : Ich muss morgen nicht zur Schule gehen.
...
내 삼촌은 나에게 차(값)를 지불해준다.
 : Mein Onkel bezahlt mir das Auto.
차고에서 나는 차 한대를 발견했다.
 : In der Garage entdecke ich ein Auto.
실례합니다만 / 죄송합니다만
 : Entschuldigen Sie bitte!
이 사진에서 내 여동생을 알아보겠니?
 : Erkennen Sie meine Schwester auf dem Foto?
그는 그의 아이에게 동화를 이야기해준다.
 : Er erzählt seinem Kind ein Märchen.
나는 이미 많은 것을 체험했다.
 : Ich habe schon vieles erlebt.
나에게 좋은 호텔을 추천해줄 수 있겠어요?
 : Können Sie mir bitte ein gutes Hotel empfehlen?
그는 손님들을 진심으로 대접한다.
 : Er emfängt Gäste sehr herzlich.
나는 그 집이 마음에 든다.
 : Das Haus gefällt mir sehr gut.
그는 저 실험에 실패한다.
 : Ihm misslingt das Experiment.
그는 자기 아들을 학대한다.
 : Er misshandelt seinen Sohn.
(이) 전쟁이 도시를 파괴한다.
 : Der Krieg zerstört die Stadt.
그녀는 그의 사진들을 갈기갈기 찢는다.
 : Sie zerreißt seine Fotos.
...
Mein Onkel bezahlt mir das Auto.
In der Garage entdecke ich ein Auto.
Entschuldigen Sie bitte! : 실례합니다만 / 죄송합니다만
Erkennen Sie meine Schwester auf dem Foto?
Er erzählt seinem Kind ein Märchen.
Ich habe schon vieles erlebt.
Können Sie mir bitte ein gutes Hotel empfehlen?
Er empfängt Gäste sehr herzlich.
Das Haus gefällt mir sehr gut.
Ihm misslingt das Experiment.
Der krieg zerstört die Stadt.
Sie zerreißt seine Fotos. 
...
- aus : out, 소진, 씌움, 채움 ...
      ...
      : aussteigen
        우리는 곧 베를린에서 하차한다.
        Wir steigen bald in Berlin aus.
        
- ein : into ...
			: einsteigen 승차하다
			  나는 곧 버스안으로 승차한다.
			  Ich steige bald in den Bus ein.
...
- mit : 동반, 함께 ...
			...
			: mitbringen 데리고 (사)오다
			  우유 하나를 사올 수 있니?
			  Kannst du bitte eine Milch mitbringen?
			  
- nach : 차후, 반복, 흉내, 추적, 지속 ...
			 : nachmachen 흉내내다
			   그 소년은 형의 모든 걸 따라한다.
			   Der Junge macht seinem Bruder alles nach.
			   
			 : nachgehen 늦게 가다
			   내 시계는 5분 늦게 간다.
			   Meine Uhr geht 5 min nach.
...
- um  : 두름, 변환, 전복 ...
			...
			: umfahren 우회한다 / 넘어뜨리다
			  ...
			  그 운전자가 어느 아이를 치어 넘어뜨린다.
			  Der Fahrer fährt ein Kind um.
...
나는 미국 시카고에서 왔어요.
: Ich komme aus den USA, aus Chicago.
나는 이란에서 왔어요.
...
이건 내 부인의 가방이에요.
: Das ist die Tasche von meiner Frau.
: Das ist die Tasche meiner Frau.
레스토랑은 은행 맞은 편에 있어요.
: Das Restaurant liegt der Bank gegenüber.

나는 오늘 내 아빠와 동물원으로 간다.
: Ich gehe heute mit meinem Vater zum Zoo.
우린 버스를 타고 베를린으로 갑니다.
...
독일어를 3주 전부터 배우고 있어요.
: Seit drei Wochen lerne ich schon Deutsch.

오늘 베를린으로 가시나요?
: Fahren Sie heute nach Berlin?
나는 집으로 갈 거에요.
: Ich will nach Hause (gehen)
식사 이후에 우린 커피를 마십니다.
: Nach dem Essen trinken wir einen Kaffee.
...
- bis : 까지
- ohne : ~ 이 없이(대게 무관사)
- gegen : ~ 에 대항하여, ~ 에 반하여, ~ 시 즈음에
- um : ~ 정각에, ~ 둘레에, ~ 에 빙둘러서
- durch : ~ 통(과)하여
- für : ~ 를 위해서, ~ 에 찬성하여, ~ 로서는
- entlang : ~ 를 따라서 (평행적)

그는 2시부터 5시까지 일합니다.
: Er arbeitet von 2 bis 5 Uhr.
그 기차는 뮌헨까지만 운행합니다.
...
: Sie reist ohne mich.
그 남자는 이유도 없이 웃는다.
: Der Mann lacht ohne Grund.
그 남자는 우산 없이 외출한다.
: Der Mann geht ohne einen Regenschirm aus.

저 차가 소년을 향해 돌진한다.
: Das Auto fährt gegen einen Jungen.
저 선생님은 12시 경에 도착하신다.
: Der Lehrer kommt gegen 12 Uhr an.

우리는 나무에 둘러 앉아 함께 노래한다.
: Wir sitzen um den Baum und singen zusammen.
나는 그녀를 6시 정각에 만납니다.
: Ich treffe sie um 6 Uhr.

나는 공원을 통과해서 간다.
: Ich gehe durch den Park.
그 말은 도시를 통과해 달립니다.
: Das pferd läuft durch die Stadt.

그녀는 가족을 위해 일한다.
: Sie arbeitet für ihre Familie.
(그)아이디어가 좋아요. 찬성이에요.
: Die Idee ist gut. Ich bin dafür.
나는 일주일 간(동안) 여기에 머뭅니다.
...
내 우산이 어디에 있지?
: Wo ist mein Regenschrim?
그건 장롱 옆에 있어요.
: Er ist neben dem Schrank.
그는 어디로 우산을 세워두나요?
: Wohin stellt er seinen Regenschirm?
장롱 옆에다가 세워둡니다.
: Er stellt ihn neben den Schrank.
...
: wo hängt die Uhr?
그것은 책 선반 위에 걸려있어요.
: Sie hängt über dem Regal.
그는 대체 저 시계를 어디로 겁니까?
: Wohin hängt er denn die Uhr?
그는 그걸 선반 위에다가 겁니다.
: Er hängt sie über das Regal.
...
집 뒤에 무엇이 있나요?
: Was gibt es hinter dem Huas?
집 뒤에는 나무 한 그루가 있어요.
: Dahinter(Hinter dem Haus) steht ein Baum.
그녀는 어디로 갑니까?
: Wohin geht sie?
그녀는 집 뒤로 갑니다.
: Sie geht hinters Huas.

그 화물차는 어디에 있나요?
: Wo ist der Lkw?
그 화물차는 집과 집 사이에 있어요.
: Der Lkw steht zwichen den Häusern.
```
...
현재 : Ich koche gern
과거 : Ich kochte gern
현완 : Ich habe gern gekocht
과완 : Ich hatte gern gekocht
미래 : Ich werde gern kochen
```
...
```
그녀는 어제 독일어를 공부했다.
 : Gestern lernte sie Deutsch.
그녀는 어디에 살았죠?
 : Wo wohnte sie?
그녀는 호숫가에 살았어요.
 : Sie wohnte am See.
내 남자친구는 오늘 오전에 일했다.
 : Mein Freund arbeitete heute Vormittag.
어제 그는 그의 자동차를 팔았다.
 : Gestern verkaufte er sein Auto.
3일 전에 나는 그를 방문했다.
 : Vor 3 Tagen besuchte ich ihn.
내 엄마와 나는 어제 장을 보았다.
 : Gestern kauften meine Mutter und ich ein.
그녀는 어디 있었죠?
 : Wo war sie?
그녀는 방안에 있었어요.
 : Sie war im Zimmer.
...
그는 교수가 되었다.
 : Er wurde Professor.
나는 전에 노래를 잘 할 수 있었다.
 : Ich konnte früher gut singen.
나는 열심히 일해야만 했다.
 : Ich musste fleißig arbeiten.
집 뒤에 무엇이 있었죠?
 : Was gab es hinter dem Haus?
집 뒤에는 나무 한 그루가 서 있었어요.
 : Dahinter stand ein Baum.
```
...
haben + p.p : 모든 타동사, 자동사, 재귀동사, 화법조동사
- 화법조동사는 과거를 더 많이 쓴다.
...
- 장소 이동
	: gekommen, gegangen, gefahren,
		geflogen, gelaufen, gefallen ...
		
- 상태 변화
	: aufgestanden, eingeschlafen, gewachsen ...
	
- 기타
	: geblieben, geworden, gewesen ...
```
...
저 여인은 과일을 장봤어요.
 : Die Frau hat Obst eingekauft.
당신은 그 자전거를 파셨나요?
 : Haben Sie das Fahrrad verkauft?

당신은 열심히 일하셨어요?
 : Haben Sie fleißig gearbeitet?
그녀는 나를 기다렸었다.
 : Sie hat auf mich gewartet.
나는 창문을 열었다.
 : Ich habe das Fenster geöffnet.
저는 독일에서 사진 많이 찍었어요.
 : Ich habe in Deutschland viel fotografiert.
나는 의학을 공부했다.
...
그녀는 어디에 살았죠?
 : Wo hat sie gewohnt?
그녀는 호숫가에 살았어요.
 : Sie hat am See gewohnt.
그녀는 어디로 갔나요?
 : Wohin ist sie gefahren?
내 남자친구는 오늘 오전에 일했다.
 : Mein Freund hat heute Vormittag gearbeitet.
어제 그는 자신의 자동차를 팔았다.
 : Gestern hat er sein Auto verkauft.
3일 전에 나는 그를 방문했다.
 : Vor 3 Tagen habe ich ihn besucht.
내 엄마와 나는 어제 장을 보았다.
 : Gestern haben meine Mutter und ich eingekauft.
그녀는 어디 있었죠?
 : Wo ist sie gewesen?
그녀는 방안에 있었어요.
 : Sie ist im Zimmer gewesen.
그녀는 어디로 갔나요?
 : Wohin ist sie gegangen?
그녀는 바다로 갔어요.
 : Sie ist ans Meer gegange.
그녀는 어디로 갔나요?
 : Wohin ist sie gefahren?
그녀는 집 앞으로 갔어요.
 : Sie ist vor das Haus gefahren.
그녀는 차가 있었다.
 : Sie hat ein Auto gehabt.
그는 마침내 교수가 되었다.
 : Er ist endlich Professor geworden.
나는 전에 노래를 잘 할 수 있었다.
 : Ich habe früher gut singen können.
집 뒤에 무엇이 있었죠?
 : Was hat es hinter dem Haus gegeben?
집 뒤에는 나무 한 그루가 서 있었어요.
 : Dahinter hat ein Baum gestanden.
```
...
```
부사
- 시간, 빈도, 장소, 방법, 상황 등의 부가적 의미로 대개 동사를 수식하며
	형용사 및 부사를 수식하기도 함.
...
빈도부사
- 부정 빈도 : 사건 및 일의 대략적 빈번도
						자주, 드물게, 한 번도 ~아닌...
- 확정 빈도 : 정확한 빈도수
						매주, 3일에 한 번, 일 주에 두 번 등
						
(gar)nie	->	fast nie	->	selten	->	manchmal, ab und zu	->	oft, häufig	->	meistens	->	immer

나는 항상 아침식사를 한다.
 : Immer frühstücke ich.
나는 아침을 먹었다.
 : Ich habe gefrühstückt.
그녀는 항상 제시간에 온다.
 : Immer kommt sie pünktlich.
 
그녀는 대체로 늦게 온다.
 : Meistens kommt sie spät.
나는 대체로 차를 타고 간다.
 : Meistens fahre ich mit dem Auto.

저녁식사 이후 나는 자주 산책을 한다.
 : Nach dem Abendessen gehe ich oft spazieren.
나는 영화관에 자주 혼자 간다.
 : Oft gehe ich allein ins Kino.
 
그는 가끔 집에서 피아노를 연주한다.
 : Manchmal spielt er zu Hause Klavier.
나는 때때로 디스코를 간다.
 : Manchmal gehe ich in die Disko.

나는 드물게 부모님을 방문한다.
 : Selten besuche ich meine Eltern.
그는 카페를 드물게 간다.
 : Selten geht er ins Cafè.

내 동료는 거의 장을 안본다.
 : Mein Kollege kauft fast nie ein.
그녀는 소고기를 거의 안 먹는다.
 : Sie isst fast nie Rindfleisch.
 
그런 일은 다시 하지 않겠습니다.
 : Das will ich nie wieder machen.
나는 아직 한 번도 독일에 가보지 못했다.
...
하루에  : am Tag	/ pro Tag
일주일에 : in der Woche	/	pro Woche
한 달에 : im Monat	/	pro Monat
일년에  : im Jahr / pro Jahr 

매일	: jeden Tag	/	täglich
매주	:	jede Woche / wöchentlich
매달	:	jeden Monat	/	monatlich
매년	: jedes Jahr / jährlich

그는 주에 두 번 그녀를 만난다.
 : Er trifft sie zweimal in der Woche.
그는 매일마다 수영을 한다.
 : Jeden Tag schwimmt er.


아침에, 아침마다 : morgens ( jeden Morgen )
저녁에, 저녁마다 : abends ( jeden Abend )
밤에 , 밤마다   : nachts ( jede Nacht )

그녀는 저녁마다 맥주를 마신다.
 : Sie trinkt abends Bier.
나는 아침마다 조깅을 한다.
 : Ich jogge morgens.
...
werden
나중에 내가 너를 방문할 것이다.
 : Später werde ich dich besuchen.
그는 내일 너를 초대할 것이다.
 : Morgen wird er dich einladen.
 : Morgen lädt er dich ein.
...
------------------------------------------------------------
e->i/e->ie(du)  어간						 어간 + t				원형 + Sie

nehmen					Nimm !					Nehmet !			Nehmen Sie !
essen						Iss !						Esst !				Essen Sie !
sehen						Sieh !					Seht !				Sehen Sie !
lesen						Lies !					Lest !				Lesen Sie !
--------------------------------------------------------------------
a->a(du)				어간						 어간 + t					원형 + Sie
...
weggehen				Geh auf !					Geht auf !						Gehen Sie auf !
zuhören					Hör mir zu !			Hört mir zu !					Hören Sie mir auf !
----------------------------------------------------------------------------
기본동사			어간									어간 + t							원형 + Sie

sein				Sei vorsichtig !  	Seid vorsichtig !			Seien Sie vorsichtig !
haben				Hab keine Sorge !		Habt keine Sorge !		Haben Sie keine Sorge !
werden			Werde reich !				Werdet reich !				Werden Sie reich !
----------------------------------------------------------------------------
doch : 제안, 촉구 (어서)
...
어서 좀 창문을 닫아라 !
 ...
 : Schließ doch bitte das Fenster !
 
너희 선생님께 여쭤봐 !
 : Fragt doch euren Lehrer !
 
(넌) 우리에게 어서 빨리 답해줘 !
 : Antworte uns doch schnell !
 
그럼 뭔가 좀 드세요 !
 : Dann essen Sie doch etwas !
---------------------------------------------------------------------------
bitte : 친절, 예의 (좀, 제발)
...
내 돈을 좀 즉시 돌려 줘 !
 : Gib mir bitte sofort mein Geld zurück !
...
봐봐! 저기 너네 엄마야 !
 : Guck mal ! Da ist deine Mutter.
 
저 외투를 한 번 입어보세요 !
 : Probieren Sie mal den Mantel an !
 
있잖아. 너 대체 애가 몇이니?
 : Sag mal, wie viele Kinder hast du denn?
...
나는 피자를 하나 먹고 콜라 한 잔 마신다.
 : Ich esse eine Pizza und trinke eine Cola.
 
나는 어제 친구를 만나서 커피를 마셨다.
 : Gestern habe ich einen Freund getroffen und eine Tasse Kaffee getrunken.
...
슈테피는 이미 48살 이지만 아직 매력적이다.
 : Steffi ist schon 48, aber noch sehr attraktiv.

그녀는 친절하지만 그녀의 남편은 상냥하지 않아요.
 : Sie ist nett, aber ihr Mann ist unfreundlich.

난 막 점심을 먹었지만 아직도 배가 많이 고프다.
 : Ich habe gerade zu Mittag gegessen, aber ich habe immer noch Riesenhunger.

나는 탁자를 하나 사지만 내 남자형제는 서랍장을 하나 산다.
 : Ich kaufe mir einen Tisch, aber mein Bruder kauft eine Kommode.
```

```
oder : A 이냐 혹은 b 이냐

너는 중국에서 왔니, 아니면 일본에서 왔니?
 : Kommst du aus China oder aus Japan?

너는 오늘 함부르크에 가니, 아니면 하노버에 가니?
 : Fährst du heute nach Hamburg oder nach Hannover?

너는 오늘 가니 아니면 내일 가니?
 : Gehst du heute oder morgen?

그는 함부르크에서 사나요 아님 뮌헨에서 사나요?
 : Wohnt er in Hamburg order in München?

네 시계는 틀림없이 비싸, 그렇지?
 : Deine Uhr ist bestimmt teur, oder?
...
그는 독일어를 배워. 왜냐하면 독일에서 공부하고 싶으니까.
 : Er lernt Deutsch, denn er möchte in Deutschland studieren.

왜 당신은 오늘 늦게 일어났죠?
 : Warum sind Sie heute spät aufgestanden?

어제 새벽에 커피를 두 잔 마셨기 때문에.
 : Ich bin heute spät aufgestanden. denn in der Nahct habe ich zwei Tassen getrunken.
...
이건 자전거가 아니라 오토바이야.
 : Das ist kein Fahrrad, sondern ein Motorrad.

우리는 일본이 아니라 한국에서 왔어요.
 : Wir kommen nicht aus Japan, sondern aus Korea.
...
```
- 2격(~의)은 기본적으로 바로 앞의 명사를 수식하여
	주로 사람, 사물의 소유 명시
- 남성 & 중성 : 어미 (-s od. -es)
- 다음절 : -s (Autos, Bruders, Onkels...)
- 단음절 : -es (Kindes, Mannes, Sohnes...)
- 명사 어미 (-s, -ß, -x, -z) : -es (Hauses, Glases, Platzes..)
- 소유의 의문사 : wessen (11강)
- 이름(고유명사) : -s / von + Dat.

내 엄마의 가방은 비싸다
 : Die Tasche meiner Mutter ist teuer.
 : Die Tasche von meiner Mutter ist teuer.
```
...
그건 내 엄마의 여권이다.
 : Das ist der Pass meiner Mutter.
 : Das ist der Pass von meiner Mutter.
 : Der Pass gehört meiner Mutter.
...
그건 내 아이의 신발입니다.
 : Das sind die Schuhe meines Kindes.
 : Das sind die Schuhe von meinem Kind.
 : Die Schuhe gehören meinem Kind.
...
그건 페터의 신발입니다.
 : Das sind Peters Schuhe.
 : Das sind die Schuhe von Peter.
 : Die Schuhe gehören Peter.
 
네 아버지의 자동차는 크다.
 : Das Auto deines Vaters ist groß.
 : Das Auto von deinem Vater ist groß.

저 의사의 자동차는 크다.
 : Das Auto des Arztes ist groß.
 : Das Auto von dem Arzt ist groß.
 
한스의 자동차는 크다.
 : Hans' Auto ist groß.
 : Das Auto von Hans ist groß.
 
내 누이의 아이들은 이미 성인이 되었다.
 : Die Kinder meiner Schwester sind schon erwachsen.
 : Die Kinder von meiner Schwester sind schon erwachsen.
 
당신 아버님의 차가 이미 수리되었습니다.
 : Das Auto Ihres Vaters wurde schon repariert.
 : Das Auto von Ihrem Vater wurde schon repariert.

내 핸드폰의 계약이 만기되었다.
 : Der Vertrag meines Handys ist abgelaufen.
 : Mein Handyvertrag ist abgelaufen.
 
내 아들의 안경은 탁자 위에 있다.
 : Die Brille meines Sohnes liegt auf dem Tisch.
 : Die Brille von meinem Sohn liegt auf dem Tisch.

내 부모님의 집은 호숫가에 있고 아름답다.
 : Das Haus meiner Eltern liegt am See, und ist schön.
 : Das Haus von meinen Eltern liegt am See, und ist schön.
 
```

------

### Lektion 27. 시간 묻고 답하기
...
저는 생일 때에 시계를 하나 받았어요.
 : Ich habe zum Geburstag eine Uhr bekommen.
...
나는 정말 독일어를 배울 시간이 없다.
 : Ich habe wirklich keine Zeit, Deutsch zu lernen.
```

```
Stunde : 1/24 시간. (수업 등) 시간
Minute : 분
Sekunde : 초
...
나는 어제 두 시간 동안 독일어를 공부했다.
 : Gestern habe ich zwei Stunden lang Deutsch gelernt.
 
나는 한 시간을 공부했다.
 : Ich habe eine Stunde gelernt.

실례지만, 지금 대체 몇 시인가요?
 : Entschuldigung, wie spät ist es denn jetzt?
 : Wie viel Uhr ist es denn jetzt?
...
Es ist sieben Uhr.
Es ist 10 nach sieben.
Es ist Viertel nach sieben.
Es ist fünf vor halb 8.
Es ist halb 8.
Es ist fünf nach halb 8.
Es ist zwanzig vor 8.

나는 내일 7시 30분에 일어날 것이다.
: Ich stehe morgen um halb 8 auf.
나는 내일 7시 30분에 일어나야 한다.
 : Ich muss morgen um halb 8 aufstehen.
나는 오늘 7 시 30분에 일어났다.
 : Ich bin heute um halb 8 aufgestanden.

나는 오늘 오후 3시 경에 서울에 도착한다.
 : Ich komme heute gegen 3 Uhr nachmittags in Seoul an.
 
내일 저녁 7시에 그를 만납니다.
 : Ich treffe ihn morgen um 7 Uhr abends.

나는 새벽 두 시에 잠자리에 들었다.
 : Ich bin um 2 Uhr nachts ins Bett gegangen.
 
나는 3시 반부터 5시까지 수업이 있다.
 : Ich habe von halb 4 bis 5 Uhr Unterricht.
```

------

### Lektion 28. 형용사 어미 변화

```
저 낡은 집은 : das alte Haus
어느 낡은 집 하나를 : ein altes Haus
좋은 집들을 : gute Häuser
...
그 책은 내 거다.
 : Das Buch gehört mir.
그 흥미로운 책은 내 거다.
 : Das interessante Buch gehört mir.
...
저 친철한 남자가 학교 앞에 서있다.
 : Das nette Mann steht vor der Schule.
저 부유한 엄마는 주말마다 피아노를 연주한다.
 : Die reiche Mutter spielt jedes Wochenende Klavier.
나는 그 친절한 남자의 예쁜 딸을 사랑한다.
 : Ich liebe die hübsche Taugter des netten Mannes.
그는 그 작은 소녀를 돕는다.
 : Er hilft dem kleinen Mädchen.
그는 그 영리한 아이들에게 답변한다.
 : Er antwortet den klugen Kindern.
저 친절한 부모님은 새로운 전시회를 방문하신다.
 : Die netten Eltern besuchen die neue Ausstellung.
...
그건 어느 작은 아이의 공이다.
 : Das ist der Ball eines kleinen Kindes.
이건 어떤 마른 여인의 개다.
 : Das ist der Hund einer dünnen Frau.
나는 어느 아름다운 여인을 돕는다.
...
그녀는 약간의 학생들을 돕는다.
 : Sie hilft einigen Schülern.
좋은 와인의 향기는 정말 다르다.
 : Das Aroma guten Weines ist wirklich anders.
...
```
Haben Sie Geld dabei? : 당신은 수중에 돈이 있습니까?
```
...
Was sind Sie von Beruf?
Seid ihr Studenten? Nein, wir sind Schüler

나의 어미니는 가정주부 입니다.
 : Meine Mutter ist Hausfrau.
내 여친은 독일 출신이고 지금 서울에 산다.
 : Meine Freundin kommt aus Deutschland
   und wohnt jetzt in Seoul.
내 형은 자전거를 즐겨 타거나 책을 읽는다.
 : Mein Bruder fährt gern Fahrrad oder liest gern.
나는 오늘 탁자 하나와 의자 셋을 산다.
 : Ich kaufe mir heute einen Tisch und drei Stühle.
그는 기혼이지만 자녀가 없어요.
 : Er ist verheiratet, aber hat keine Kinder.
일요일에 누나와 나는 영화관으로 간다.
 : Am Sonntag gehen meine Schwester und ich ins Kino.
혹시 그 영화를 보셨나요?
 : Haben Sie sich vielleicht den Film angeschaut?
그 남자의 자동차는 매우 비싸다.
 : Das Auto des Mannes ist sehr teuer.
나는 내 친구들과 4시에 카페에서 만난다.
 : Ich treffe mich um vier Uhr im Cafè mit meinen Freunden.
혹시 남자형제가 있으세요?
 : Haben Sie vielleicht einen Bruder?
그 여인은 그 남자를 사랑하지만 그는 그녀를 사랑하지 않아요.
 : Die Frau liebt den Man, aber er liebt sie nicht.
그들은 우리들에게 집 찾는 걸 도와준다.
 : Sie helfen uns bei der Wohnungssuche.
그녀의 아들이 매우 똑똑하다.
 : Ihr Sohn ist sehr klug.
그의 두 명의 아들이 오늘 축구를 한다.
 : Seine beiden Söhne spielen heute Fußball.
잘 지내시지요?
 : Wie geht's Ihnen? / Geht's Ihnen gut?
언제부터 독일어를 공부하신건가요?
 : Seit wann lernen Sie schon Deutsch?
Warum lernen Sie so fleißig Deutsch?
Ich will in Deutschland studieren.
무엇을 타고 부산으로 가세요?
 : Womit fahren Sie nach Busan?
Der Tisch ist groß und praktisch.
저 큰 탁자는 바로 장롱 옆에 서 있다.
 : Der große Tisch steht direkt neben dem Schrank.
난 저 빨간 소파를 꽤 저렴하다고 생각해 !
 : Ich finde das rote Sofa ziemlich günstig !
추워요. 저 문을 좀 닫아 주실 수 있나요?
 : Es ist kalt. Können Sie bitte die Tür zumachen?
난 오늘 공부해야 해! 내일 중요한 시험이 있어.
 : Ich muss heute lernen! Ich habe morgen nämlich eine wichtige Prüfung.
엄마, 제가 오늘 장보러 갈까요?
 : Mutter, soll ich heute mal einkaufen gehen?
전 나중에 춤추는 걸 배우고 싶어요.
 : Ich möchte später tanzen lernen.
2년 뒤에 독일에서 공부할 겁니다.
 : In zwei Jahren will ich in Deutschland studieren.
뭣 좀 여쭤봐도 될까요?
 :  Darf ich Sie mal etwas fragen?
내일 내게 전화해줄 수 있어?
 : kannst du morgen mich anrufen?
저 기차는 10분 뒤에 서울에 도착한다.
 : In zehn Minuten kommt der Zug in Seoul an.
그는 어제 자신의 자동차를 팔았다.
 : Gestern hat er sein Auto verkauft.
...
### Lektion 2. 준비강의 2강 (복습)

```
어제 영화가 맘에 드셨나요?
 : Hat Ihnen der Film gefallen??
그녀는 주말에 즐겨 장을 보고 tv를 봅니다.
 : Sie kauft gern am Wochenende ein und sieht gern fern.
그 부부는 어제 19시에 외출했다.
 : Gestern ist das Ehepaar um neunzehn Uhr ausgegangen.
저 탁자위에 책 한권과 볼펜 두 자루가 있다.
 : Auf dem Tisch liegen ein Buch und zwei Kulis.
그는 거울 하나를 벽에다 건다.
 : Er hängt einen Spiegel an die Wand.
그는 자신의 자동차를 차고에다가 세웠다.
 : Er hat sein Auto in die Garage gestellt.
내일 나는 내 친구와 베를린으로 간다.
 : Morgen fahre ich mit meinem Freund nach Berlin.
한 달 전부터 난 서울에서 살고 있다.
 : Seit einem Monat lebe ich in Seoul.
수업 후에 난 병원에 간다.
 : Nach dem Unterricht gehe ich zum Arzt.
스위스에서 온 내 친구는 내일까지 내 집에 머무른다.
 : Mein Freund aus der Schweiz bleibt bis morgen bei mir.
오늘은 엄마를 위해 선물 하나를 산다.
 : Heute kaufe ich für meine Mutter ein Geschenk.
대학생들이 반 등록금 시위를 한다.
 : Studenten demonstrieren gegen Studiengebühren.
난 어제 박물관으로 갔다.
 : Gestern bin ich ins Museum gegangen.
난 어제 가족들과 박물관으로 갔다.
 : Gestern bin ich mit meiner Familie ins Museum gegangen.
난 어제 초대했다.
 : Gestern habe ich eingeladen.
나는 어제 내 이웃들을 초대했다.
 : Gestern habe ich meine Nachbarn eingeladen.
나는 어제 내 이웃들을 커피에 초대했다.
 : Gestern habe ich meine Nachbarn zum Kaffee eingeladen.
나는 내 부모님을 드물게 방문한다.
 : Ich besuche meine Eltern selten.
난 항상 아침식사 때에 커피를 마신다.
 : Zum Frühstück trinke ich immer Kaffee.
난 독일에 아직 한 번도 안 가봤다.
 : Ich war noch nie in Deutschland.
그녀는 오늘 베를린으로 가지 않고 산책하러 간다.
 : Heute fährt sie nicht nach Berlin, sondern geht spazieren.
그는 일본에서 왔지만 지금 서울에서 산다.
 : Er kommt aus Japan, aber lebt jetzt in Seoul.
난 매우 피곤해서 디스코텍에 못 가.
 : Ich kann nicht in die Disco gehen, weil ich sehr müde bin.
내 부모님의 차는 매우 오래되었다.
 : Das Auto meiner Eltern ist sehr alt.
다니엘의 친구들이 한국을 방문했다.
 : Die Freunde von Daniel haben Korea besucht.
   Daniels Freunde haben Korea besucht.
내 아들의 친구들은 매우 친절하고 모두 키가 정말 큽니다.
 : Die Freunde meines Sohnes sind sehr nett und alle so sehr groß.
저 영화는 20시 30분에 시작한다.
 : Der film fängt um halb 21 an.
19시 25분에 저 비행기가 도착한다.
 : Fünf vor halb 20 kommt das Flugzeug an.
나는 작은 가방 하나를 필요로 한다.
 : Ich brauche eine kleine Tasche.
이 작은 가방은 내 여동생 겁니다.
 : Die kleine Tasche gehört meiner jüngeren Schwester.
저 빨간 자동차를 저 아름다운 숙녀가 좋게 생각합니다.
 : Das rote Auto gefällt der schönen Dame.
 : Das rote Auto findet die schöne Dame super.
내 남친의 승용차 안에 있는 저 비싼 선글라스는 내 남동생의 여자친구의 것이다.
 : Die teure Sonnenbrille in dem Auto meines Freundes gehört der Freundin meines kleinen Bruders.
 
```

------

### Lektion 1. 동사의 유형과 문장 형식
...
Ich bin Lehrer : 난 선생님이다.
Meine Tochter ist Schülerin : 내 딸은 학생이다.
Ich wurde Lehrer : 난 선생님이 되었다.
Sie ist Studentin geworden : 그녀는 여대생이 되었다.
```

```
3. Verb + 1격 + 4격

너는 날 사랑해? : Liebst du mich?
나는 그를 방문한다. : Ich besuche ihn.
난 숙제를 했다. : Ich habe Hausaufgabe gemacht.
너는 나를 방문해줄 수 있어? : Kannst du mich besuchen?
드디어 방 하나를 찾았습니다. : Endlich habe ich ein Zimmer gefunden.

```

```
4. Verb + 1격 + 3격
	: danken, folgen, gefallen, gehören, glauben,
	  gratulieren, helfen, schmecken.

초대해 줘서 고마워. : Ich danke dir für die Einladung.
저 책은 내 거다. : Das Buch gehört mir.
파티는 내 맘에 들었다. : Die Party hat mir gut gefallen.
저 여인이 그들을 도왔다. : Die Frau hat ihnen geholfen.
...
5. Verb + 1격 + 전치사격 보충어
  : sich + 동사원형 + 전치사 (숙어)
	: sich freuen auf + 4격, warten auf + 4격, denken an + 4격
	
널 이미 한 시간 동안 기다리고 있다.
 : Auf dich warte ich schon eine Stunde lang.
난 항상 그녀를 생각하고 있다.
 : Ich denke immer an sie.
내 부모님은 내 선물에 매우 기뻐하셨다.
 : Meine Eltern haben sich sehr über mein Geschenk gefreut.

```

```
6. Verb + 1격 + 3격 + 4격
	: empfehlen, geben, erzählen, schenken, zeigen ...
	
제게 메뉴판을 가져다 주실 수 있나요?
 : Würden Sie mir bitte die Speisekarte bringen?
 : Würden Sie sie mir bitte bringen?
내 이웃 남자가 내게 볼펜 하나를 선물했다.
 : Mein Nachbar hat mir einen Kuli geschenkt.
 : Mein Nachbar hat ihn mir geschenkt.
나는 너희들에게 휴가 사진을 보여준다.
...
Ich spiele Fußball.
 ...
 Er hatte einen Film gesehen.
 Er wird einen Film sehen.
 
 Ich komme nach Hause.
 Ich kam nach Hause.
 Ich bin nach Huase gekommen.
 ...
 Wir waren in Deutschland gewesen.
 Wir werden in Deutschland sein.
...
그는 바로 내게 그 이메일로 답장을 준다.
 : Er antwortet mir gleich auf die E-Mail.
그가 지금 티비를 보고 칩스를 먹습니다.
 : Er sieht jetzt fern und isst Chips.
독서를 즐기니 아니면 오히려 친구들을 만나?
 : Liest du gern oder triffst du lieber Freunde?
너는 어디로 가니?
 : Wohin fährst du?
나는 독일로 가.
...
너는 어떤 호텔은 나에게 추천하니?
 : Welches Hotel empfiehlst du mir?
인터네셔널 호텔을 추천해.
 : Ich empfehle dir das "International".
...
나는 부산으로 갔어요.
 : Ich bin nach Busan gefahren.

넌 누구를 도와줬었니?
 : Wem halfst du denn?
저는 어느 아이를 도와줬어요
 : Ich half einem Kind.
 : Ich habe einem Kind geholfen.
어떤 호텔을 나에게 추천했었니?
 : Welches Hotel empfahlst du mir?
 : Welches Hotel hast du mir geempfohlen?
인터내셔널 호텔을 추천했어.
 : Ich habe dir das "International" empfohlen.
...
- 독일어 분리동사
	: an(부착) + rufen(부르다) = 전화걸다
	: Ich rufe dich an.
	
- 분리/비분리동사
	: unter(하부) + suchen(찾음) = 진찰하다
	: Der Arzt hat mich kurz untersucht.
```

```
복합동사의 비교

현재 : Er kauft heute ein.
과거 : Er kaufte heute ein.
현완 : Er hat heute eingekauft.
과완 : Er hatte heute eingekauft.
미래 : Er wird heute einkaufen.
...
ent - 벗김, 없앰, 시작 : entdecken 발견하다
		- 벗김, 없앰, 시작 : entwickeln 발전시키다
    - 벗김, 없앰, 시작 : entscheiden 결정하다

er - 4격, 완성 : erfahren 경험하다
	 - 4격, 완성 : erleben 체험하다
	 - 4격, 완성 : erlernen 습득하다
	 - 4격, 완성 : erwarten 기대하다
	 
ge - 일치, 성공 : gebrauchen 사용하다
	 - 일치, 성공 : gefallen 마음에 들다
	 - 일치, 성공 : gehören ~ 것 이다.
	 - 일치, 성공 : gelingen ~에게 성취되다
	 
ver - 대리, 낭비, (추상) : verbrauchen 소비하다
		- 대리, 낭비, (추상) : verbringen ~(시간 등)을 보내다
		- 대리, 낭비, (추상) : vergessen 잊다
		- 대리, 낭비, (추상) : verlieren 잃어버리다
		- 대리, 낭비, (추상) : vermieten 임대하다
		- 대리, 낭비, (추상) : verpassen 놓치다
		- 대리, 낭비, (추상) : versorgen ~를 부양, 제공하다.
		- 대리, 낭비, (추상) : versprechen 약속하다(미래 등)
		- 대리, 낭비, (추상) : verstehen 이해하다
		- 대리, 낭비, (추상) : vertreten 대표(변)하다
		
emp, zer(가치하락), miss(오류) : empfehlen 추천하다
													  : empfangen 응접하다
													  : zerfallen 붕괴하다
													  : zerreißen 갈기갈기 찢다
													  : zerstören 파괴하다
...
```
Michael bekommt ein Stipendium(장학금)
Michael hat ein Stipendium bekommen.

Lena vergisst immer ihren Geburtstag.
Lena hat immer ihren Geburtstag vergessen.

Er erzählt mir eine Geschichte.
Er hat eine Geschichte erzählt.

Er empfängt die Gäste ganz herzlich.
Er hat die Gäste ganz herzlich empfangen.

Sie entscheidet sich für die neue Wohnung.
Sie hat sich für die neue Wohnung entschieden.
```

```
복합동사 - 분리동사

an - 접근, 약간, 부착, 개시, 지속 : ankommen 도착하다
   - 접근, 약간, 부착, 개시, 지속 : anfangen (mit) 시작하다
   - 접근, 약간, 부착, 개시, 지속 : anrufen 전화 걸다
   - 접근, 약간, 부착, 개시, 지속 : ansehen 주시하다
   
auf - 위로, 윗면(on), 엶, 공개, 재발 : aufstehen 기상하다
    - 위로, 윗면(on), 엶, 공개, 재발 : aufbauen 건축하다
    - 위로, 윗면(on), 엶, 공개, 재발 : aufhören (mit) 그만두다
    - 위로, 윗면(on), 엶, 공개, 재발 : aufnehmen 녹화하다, 받아들이다
    
aus - 밖으로, 배출, 완성, 탈락, 연장, 선택, 소진(충분히) : ausgehen 외출하다
		- 밖으로, 배출, 완성, 탈락, 연장, 선택, 소진(충분히) : aussehen ~처럼 보이다
		- 밖으로, 배출, 완성, 탈락, 연장, 선택, 소진(충분히) : auspacken 포장(등을) 풀다
		- 밖으로, 배출, 완성, 탈락, 연장, 선택, 소진(충분히) : ausfüllen 가득 채우다
		- 밖으로, 배출, 완성, 탈락, 연장, 선택, 소진(충분히) : austrinken 다 마시다
		
bei - 옆, 접근, 협력, 동봉 : beitragen (zu) 기여하다
    - 옆, 접근, 협력, 동봉 : beiliegen 동봉되다
    
mit - 동반, 협동, 관여 : mitbringen 가지고 (사)오다
    - 동반, 협동, 관여 : mitteilen 전달하다
    
nach - 뒤에, 흉내, 추구, 반복 : nachprüfen 재심사하다
     - 뒤에, 흉내, 추구, 반복 : nachfragen 재차 질문하다
     - 뒤에, 흉내, 추구, 반복 : nachmachen 흉내내다
     - 뒤에, 흉내, 추구, 반복 : nachdenken 숙고하다
     
vor - 앞에, 선두, 이전, 우위(부사와 함께 쓰이기도 함) : vorbeifahren 지나가다
    - 앞에, 선두, 이전, 우위(부사와 함께 쓰이기도 함) : vorhersagen 예보하다
    - 앞에, 선두, 이전, 우위(부사와 함께 쓰이기도 함) : vorschlagen 제안하다
    - 앞에, 선두, 이전, 우위(부사와 함께 쓰이기도 함) : vorstellen 소개하다
    - 앞에, 선두, 이전, 우위(부사와 함께 쓰이기도 함) : vorbereiten 준비하다
    
 zu - 방향, 첨가, 폐쇄, 귀속 : zugreifen 손을 뻗어 쥐다
    - 방향, 첨가, 폐쇄, 귀속 : zunehmen 증가하다
    - 방향, 첨가, 폐쇄, 귀속 : zumachen 닫다
    
 ab - 제거, 이탈, 아래, 감소 : abfahren 출발하다
    - 제거, 이탈, 아래, 감소 : abnehmen 감소하다
    - 제거, 이탈, 아래, 감소 : abschreiben 표졀하다
    - 제거, 이탈, 아래, 감소 : abschließen 졸업하다
    - 제거, 이탈, 아래, 감소 : absagen 취소하다
    
ein - 안으로, 수축, 내재된 : einkaufen 장보다
    - 안으로, 수축, 내재된 : einsteigen 승차하다
    - 안으로, 수축, 내재된 : einladen 초대하다
    - 안으로, 수축, 내재된 : einschlafen 잠들다
    - 안으로, 수축, 내재된 : einpacken 포장하다
    - 안으로, 수축, 내재된 : einatmen 숨쉬다
    
zurück - 뒤에, 되돌려(원상복귀) : zurückgeben 되돌려주다
       - 뒤에, 되돌려(원상복귀) : zurückkommen 돌아오다
       
zusammen - 공동, 협력, 붕괴 : zusammenfassen 요약하다
         - 공동, 협력, 붕괴 : zusammenarbeiten 함께 일하다
         
weg - 떠남, 이탈 : weggehen 가버리다

her - 화자 방향으로 : herstellen 생산하다

hin - 그곳으로 : hinfallen 넘어지다

heim - 집, 고향 : heimkehren 귀향하다

los - 느슨함, 풀어짐, 분리, 돌발 : losbinden (매듭 등을) 풀다
    - 느슨함, 풀어짐, 분리, 돌발 : losfahren 출발하다

da - 거기에 : dasein 거기에 있다

< 기타 활용법 >
명사 전철 : teilnehmen (an) 참여하다 / stattfinden : 개최되다, 열리다
형용사 : freihaben 쉬다 / festnehmen 체포하다 / feststellen 밝혀내다(고정)
동사전철 : kennen lernen 알게되다 / spazieren gehen 산책하러 가다

```

```
Die Touristen sind in den Zug eingestiegen.
Der Mann hat einen Text vorgelesen.

Das Konzert fängt um 19 Uhr an.
Das Konzert hat um 19 Uhr angefangen.

Er erzählt mir eine Geschichte.
Er hat mir eine Geschichte erzählt.

Meine Mutter sieht sehr müde aus.
Meine Mutter hat sehr müde ausgesehen.
Sie hat ihre Cola ausgetrunken.

Der Film war total langweilig. Ich bin gleich eingeschlafen.
Ich muss eine Diät machen, weil ich viel zugenommen habe. 
...
Der Doktor untersucht den Kranken.
Der Doktor hat den Kranken untersuchtl

Er übernachtet in einem Hotel (übernachten).
...
### Lektion 4.  화법조동사의 시제 + 본동사 문장구조

```
 1. 화법조동사의 세부적 의미
 2. 화법조동사의 시제에 따른 용법 비교
 3. 화법조동사와 함께 고급문장 만들기
```

```
			können			wollen			möchte			dürfen			sollen			müssen
------------------------------------------------------------------------
ich		kann				will				möchte			darf				soll				muss
du		kannst			willst			möchtest		darfst			sollst			musst
er		kann				will				möchte			darf				soll				muss
wir		können			wollen			möchten			dürfen			sollen			müssen
ihr		könnt				wollt				möchtet			dürft				sollt				müsst
Sie		können			wollen			möchten			dürfen			sollen			müssen

```

```
화법조동사(Modalverben)의 3요형

현재					과거					과거분사					의미
---------------------------------------------------
können			konnte			 gekonnt				할 수 있다
wollen			wollte			 gewollt				할 것이다
mögen				mochte			 gemocht				좋아하다
möchte			wollte			 gewollt				하고 싶다
dürfen			durtte			 gedurft				해도 된다
sollen			sollte			 gesollt				해야 한다
müssen			musste			 gemusst				해야만 한다
```

```
화법조동사 (Modalverben) 과거 도표

			können			wollen			mögen			dürfen			sollen			müssen
------------------------------------------------------------------------
ich		konnte			wollte			mochte		durfte			sollte			musste
du		konntest		wolltest		mochtest	durftest		solltest		musstest
er		konnte			wollte			mochte		durfte			sollte			musste
wir		konnten			wollten			mochten		durften			sollten			mussten
ihr		konntet			wolltet			mochtet		durftet			solltet			musstet
Sie		konnten			wollten			mochten		durften			sollten			mussten
...
1. 화법조동사
 - 상황에 맞게 특정한 의미 부여
 - 본동사로도 사용 : sein, haben, werden & 화법조동사 등
 
화법조동사 - 본동사 (Vollverb) *현재완료형보다 과거형을 많이 씀*
화법조동사 과거형 + R
-----------------------------------------------------------------------
현재			Ich			kann			gut			Deutsch
과거			Ich			konnte		gut			Deutsch
현완			Ich 		habe			gut			Deutsch			gekonnt

현재			Ich			will			einen Apfelkuchen
과거			Ich			wollte		einen Apfelkuchen
현완			Ich			habe			einen Apfelkuchen		gewollt


화법조동사의 시제 별 문장구조
이중원형 : *현재완료형(haben/sein) 뒤에 동사가 2이상 올 경우 모두 원형으로 대체*
-----------------------------------------------------------------------
현재			Er			kann			gut			malen
과거			Er			konnte		gut			malen
현완			Er			hat				gut			malen			können
미래			Er			wird			gut			malen			können


화법조동사의 문장구조
------------------------------------------------------------------------
Sie geht nicht in die Disko.
-> Sie kann nicht in die Disko (gehen)

Er macht die Hausaufgabe.
-> Er muss die Hausaufgabe machen.


화법조동사의 현재완료 및 과거 문장 만들기
 : Jeden Tag soll mein Freund das Bad putzen.
 : Jeden Tag sollte mein Freund das Bad putzen.
 : Jeden Tah hat mein Freund das Bad putzen sollen.
 
 : Nach der Schule dürfen die Schüler ins Kino gehen.
 : Nach der Schule durften die Schüler ins Kino gehen.
 : Nach der Schule haben die Schüler ins Kino (gehen) gedurft.
 
 : Kannst du ihm bitte bei der Mathearbeit helfen?
 : Konntest du ihm bitte bei der Mathearbeit helfen?
 : Hast du ihm bitte bei der Mathearbeit helfen können?
 
화법조동사의 과거 문장 만들기
 Beispiel : Ich bin gestern früh ins Bett gegangen.
 (wollen) : Ich wollte gestern früh ins Bett gehen.

 Beispiel : Seine Tochter hat viel gelernt.
 (müssen) : Seine Tochter musste viel lernen.

 Beispiel : Die Kinder haben lange geschlafen.
 (dürfen) : Sie durften lange schlafen.

자주 사용하는 화법조동사 문장
 여기 주차해도 되요 : Man darf kann hier parken.
 여기서는 흡연 금지! : Hier darf man nicht rauchen / Rauchen verboten!
 그 남자가 가난하대(소문) : Er soll arm sein.
 그 남자가 사무실에 있는 게 틀림없어.(추측의 정도)
  : Er muss sicher(bestimmt) im Büro sein.
  
 너는 오늘 일 할 필요 없어.(müssen nicht + R)
  : Du musst heute nicht arbeiten.
  : Heute brauchst du nicht zu arbeiten. (brauchen nicht zu + R)
  
 난 오늘 일 할 필요 없었어.
  : Heute musste ich nicht arbeiten
  : Heute brauchte ich nicht zu arbeiten.
 
커피 아니면 차? 뭐 마실래?
 : Kaffee oder Tee? Was willst/möchtest du?
...
이것은 어느 비싼 탁자와 현대적인 램프다.
 : Das sind ein teurer Tisch und eine moderne Lampe.

나는 어느 임신한 여인을 돕는다.
 : Ich helfe einer schwangeren Frau.
 = Ich helfe einer Schwangeren.

당신의 자녀들은 더 많이 신선한 과일을 먹어야겠군요.
 : Ihre Kinker sollten mehr frisches Obst essen.
 
나는 즐겨 흑맥주를 마시고 내 와이프는 프랑스산 와인을 마신다.
 : Ich trinke gern dunkles Bier und meine Frau trinkt französischen Rotwein
```
...
현재분사		R + -d + 어미변화					Das spielende Kind ist mein Sohn
					( ~하고 있는, 하는(진행) )

완료분사		P.P + 어미변화
				 ( ~된, 했던(능동 완료) )		Das gekochte Ei schmeckt mir nicht gut
				 

공부하는 학생
 : Der lernende Student
 : Der jetzt lernende Student sieht müde aus.
여행하는 여성
 : Die reisende Frau
 : Die (R)reisende (Frau) ist jetzt am Badestrand.
자고있는 아기
 : Das schlafende Baby
 
다친 학생
 : Der verletzte Student
고쳐진 세탁기
 : Die reparierte Waschmaschine
 : Die vor einer Woche reparierte Waschmaschine funktioniert gut.
떠난 자동차
 : Das abgefahrene Auto
 : Das gerade am Bahnhof abgefahrene Auto hatte einen schweren Unfall.
```
...
현재분사								명사							완료분사								명사
studieren + d			der Studierende			angestellt				der Angestellte
									die Studierende												die Angestellte

vorsitzen + d			der Vorsitzende			behindert					der Behinderte
									die Vorsitzende												die Behinderte
									
reisen + d				der Reisende				verletzt					der Verletzte
									die Reisende													die Verletzte
									
나는 그녀의 친척들을 방문했다.
 : Ich habe ihre Verwandten besucht.
 
그녀의 여자사촌은 둘인데 모두 회사원이다.
 : Sie hat zwei Cousinen und die beiden sind Angestellte.
 
그 여행객들은 모두 친절했다.
 : Die allen Reisenden waren sehr nett.

그 여행객들 중 한명이 내 마음에 쏙 들었다.
 : Ein Reisender von die Reisenden hat mir sehr gut gefallen.
 : Einer der Reisenden hat mir sehr gut gefallen.
 
```

```
명사화 된 etwas / nichts + 형용사 ( 중성 강변화 )

		어떤 ~ 것							~ 것은 없다, 아니다
  etwas Neues								nichts Neues
 		   -												 -
 	etwas Neuem								nichts Neuem
 	etwas Neues							  nichts Neues
```

------

### Lektion 6. 재귀동사(Reflexive Verben) & 숙어

```
1. 재귀동사의 정의와 형태
2. 재귀대명사의 격 구별법
3. 동사 + 재귀대명사 : 필수적- & 임의적 재귀동사
4. 동사 + 재귀대명사 + 전치사의 숙어표현 - 암기하고 문장 만들기
```

```
a. 재귀동사의 정의
	: 주어의 동작과 느낌이 다시 주어로 복귀

b. 재귀동사의 특징
	1. 재귀대명사 항상 사용
	2. ich, du, wir, ihr - 인칭대명사 3,4격과 동일
	3. 3인칭 단,복수 및 존칭 - sich(3,4격)
...
sich(3격) + 4격 목적어 od. 신체 일부분

sich(3) etwas kaufen : ~ 에게 ~ 을 사주다
sich(3) etwas waschen : ~ 부위를 씻다
sich(3) die Zähne putzen : 치아를 닦다

Ich kaufe meinem Kind ein Eis.
Ich wasche mir die Hände.
Gleich nach dem Essen putzt er sich die Zähne.
Das kann ich mir gut vorstellen.
-----------------------------------------------
sich(4격) 3격, 전치사격 목적어 od. 목적어(x)

sich(4) Dat. nähern : ~ 에 가까워지다
sich(4) Dat. widmen : ~ 에게 전념, 헌신하다

Der ICE nähert sich der Grenze.
...
- 필수적 재귀 ( 재귀적으로만 사용 )
	sich erholen ( 쉬다, 회복하다 )
	 : Ich habe mich von dem Schock gut erholt.
	
	sich verspäten ( 지각, 연착하다 )
	 : Der Zug hat sich 20 Minuten verspätet
	 
	sich erkälten ( 감기 걸리다 )
	 : Ich habe mich leicht erkältet.
	 
	sich beeilen ( 서두르다 )
	 : Beeil dich doch, sonst wirst du den Zug verpassen.
	 
- 필수적 재귀 ( 4격의 재귀적으로 자주 쓰이는 동사 )
 	1. sich ausruhen ( 몸을 쉬다 )
 	2. sich befinden ( ~에 위치하다 )
 	3. sich ereignen ( ~이 발생하다 )
 	4. sich erkundigen nach(3) ( 문의하다 )
 	5. sich irren in(3) ( 착각, 혼돈하다 )
 	6. sich verabreden mit(3) ( ~와 약속하다 )
 	7. sich wundern über(4) ( ~에 놀라다 )
 	
```

```
1. 그는 어느 독일 여대생과 사랑에 빠졌다.
	 : Er hat sich in eine deutsche Studentin verliebt.
2. 아버지는 자주 내 계획에 대해 문의하신다.
	 : Mein Vater erkundigt sich oft nach meinen Plänen.
3. 나는 너의 인내심에 놀랍다 ( f.Geduld )
	 : Ich wundere mich über deine Geduld.
4. 대학생들이 교수님께 감사해 한다.
	 : Die Studenten bedanken sich bei ihrem Professor.
```
...
- 임의적 재귀 ( 4격 재귀대명사 )
	 : Ich wasche meine Tochter.
	 : Ich habe meine Tochter gewaschen.
	 : Ich wasche mich.
	 : Ich habe mich gewaschen.
	 
	 : Ich setze meine Tochter auf den Stuhl.
	 : Ich habe meine Tochter auf den Stuhl gesetzt.
	 : Ich setze mich auf den Stuhl.
	 : Ich habe mich auf den Stuhl gesetzt.
	 
- 임의적 재귀동사 ( 목적어 대신 재귀대명사 4격 )
	1. sich ändern ( 바뀌다 )
	2. sich anziehen ( 옷을 입다 )
	3. sich ärgern über(4) ( ~ 에 화를 내다 )
	4. sich bewegen ( 움직이다 )
	5. sich fürchten vor(3) ( ~ 에 두려워하다 )
	6. sich verletzen ( 다치다 )
	
	1. 그는 옷을 입고 외출한다.
		 : Er zeiht sich an und geht aus.
		 : Er hat sich angezogen und ist ausgegangen.
	2. 왜 그렇게 흥분하니? 어서 진정해! (sich aufregen / sich beruhigen)
		 : Warum regst du dich so auf? Beruhige dich doch !

- 임의적 재귀 ( 재귀대명사 3격 + 4격 목적어 )
	 : Ich kämme meine Tochter.
	 : Ich habe ihr die Haare gekämmt.
	 : Ich kämme mich (selbst).
	 : Ich habe mich (selbst) gekämmt.
	 : Ich habe mir die Haare gekämmt.
	 
	 : Ich kaufe ihr ein teures Auto.
	 : Ich kaufte ihr ein teures Auto.
	 : Ich habe ihr ein teures Auto gekauft.
	 : Ich kaufe mir ein Auto.
	 : Ich kaufte mir ein Auto.
	 : Ich habe mir ein Auto gekauft.
	 
	1. sich etwas ansehen ( 관람, 구경하다 )
	 : Ich sehe mir einen Film an.
  2. sich etwas bestellen ( ~ 을 주문하다 )
   : Ich bestelle ihr eine Cola.
  3. sich etwas leisten (können) ( ~ 을 감당하다 )
   : Ich kann mir das teures Auto nicht leisten.
  4. sich etwas merken ( ~ 을 알아채다, 기억하다 )
   : Ich merke mir ~~
  5. sich etwas vornehmen ( 계획하다 )
  6. sich etwas vorstellen ( 상상하다 )
	7. sich etwas wünschen ( 원하다 )
	
1. Herr Kim이 내일 자동차를 살 거다.
	 : Er will sich morgen ein teures Auto kaufen.
2. Herr Kim이 어제 자동차를 사려고 했다.
	 : Er wollte sich gestern ein Auto kaufen.
3. 생일 때 저는 인형 하나를 원합니다.
	 : Zum Geburtstag wünsche ich mir eine Puppe.
...
```
1. 상호 재귀대명사의 정의
2. lassen sich + R : ~ 될 수 있다.
3. 동사 + 재귀대명사 + 전치사의 숙어표현 - 암기하고 문장 만들기
4. sich(4) + 전치사격 목적어 30개 선별
```
...
1. 상호 재귀대명사란
	a. 재귀적 의미보단 상호적 의미
	b. 스스로 ( x ) - 서로서로 ( o )
	 : sich kennen / sich wiedersehen / sich treffen
...
이 자전거는 간단히 수리될 수 있다.
 : Das Fahrrad lässt sich leicht reparieren.
 = Es ist leicht zu reparieren.
 = Man kann es leicht reparieren.
 = Es kann leicht repariert werden.

이 문제는 쉽게 해결 될 수 있다.
 : Das Problem lässt sich einfach lösen.
 = Es ist einfach zu lösen.
 = Man kann es einfach lösen.
 = Es kann einfach gelöst werden.
...
1. sich erinnern an(4) ( ~ 을 기억하다, 회상하다 )
	 : Ich erinnere mich immer an dich.
	 : Erinnerst du dich an mich?

2. sich wenden an(4) ( ~ 에게 의뢰(문의)하다 )
	 : Bei Rückfragen wenden Sie sich an Herrn Kim.
	 : An wen soll ich mich bitte wenden?
	 
3. sich gewöhnen an(4) ( ~에 익숙해지다 )
	 : Ich muss mich an das deutsche Klima gewöhnen.

4. sich beteiligen an(3) ( ~ 에 참여하다 )
	 : Die Studenten beteiligen sich am Seminar.
	 
5. sich freuen auf(4) ( ~ 을 학수고대 하다 )
	 : Ich freue mich auf die Winterferien.
	 
6. sich konzentrieren auf(4) ( ~ 에 집중하다 )
	 : Sie konzentriert sich ganz auf die Prüfung.
	 : Worauf konzentrierst du dich denn?
	 
7. sich verlassen auf(4) ( ~ 를 신뢰하다 )
	 : Du kannst dich auf mich verlassen.
	 
8. sich vorbereiten auf(4) ( ~ 을 준비하다 )
	 : Sie bereitet sich auf eine Präsentation vor.
	 
9. sich bedanken bei(3) für(4) ( ~ 에게 ~ 에 감사해 하다 )
	 : Ich bedanke mich bei Ihnen für die Hilfe.
	 
10. sich eignen für(4) ( ~ 에 적합하다 )
	 : Maria eignet sich nicht für diesen Job.
	 
11. sich entschuldigen bei(3) für(4) ( ~ 에 사과하다 )
	 : Sie entschuldigt sich für ihren Fehler.
	
12. ich interessieren für(4) ( ~ 에 관심을 갖다 )
	 : Ich interessiere mich für klassische Musik.

13. sich einsetzen für(4) ( 지지하다, 변호하다 )
	 : Ich setze mich im Moment für Tiere ein.
	 
14. sich entscheiden für(4) ( ~ 으로 결정하다 )
	 : Frauen entscheiden sich gern für Gold.
	 
15. sich schämen für ( ~ 부끄럽다 )
	 : Ich schäme mich für das Verhalten meines Kindes.
	 
16. sich beschäftigen mit ( ~ 빠져 있다 )
	 : Ich beschäftige mich zurzeit mit Blumen.

17. sich treffen mit ( ~ 와 (약속해서) 만나다 )
	 : Ich treffe mich heute Abend mit meinem Freund.
	 
18. sich unterhalten mit(3) über(4) ( ~와 ~ 담화 나누다 )
	 : Sie unterhält sich jetzt mit ihren Kolleginnnen.
	 
19. sich verabreden mit ( ~와 약속하다 )
	 : Ich habe mich schon mit meiner Frau verabreden.
	 
20. sich bemühen um(4) ( ~ 을 얻으려 노력하다 )
	 : Ich habe mich um ein Stipendium bemüht.
	 
21. sich bewerben bei(3) um(4) ( ~ 에 지원, 응모하다 )
	 : Sie bewirbt sich um eine Stelle als Sekretärin.
	 
22. es handelt sich um(4) ( ~ 이 관건이다, 중요하다 )
	 : Es handelt sich hier um meine Ehre.

23. sich kümmern um(4) ( ~ 돌보다, 신경 쓰다 )
	 : Sandra kümmert sich um ihre Eltern.

24. sich verabschieden vor ( 작별하다 )
	 : Darf ich mich von euch verabschieden?

25. sich befreien von ( ~ 에서 해방되다 )
	 : Sie hat sich von ihren Sorgen befreit.
	
26. sich schützen vor ( ~ 을 보호하다 )
	 : Man muss sich vor Ansteckung schützen.
	 
27. sich ärgern über ( 화가 나다 )
	 : Über wen ärgerst du dich denn so?

28. sich beschweren über ( ~ 에 불평하다 )
	 : Sie beschwert sich immer über ihren Ehemann.
	 
29. sich freuen über ( ~ 에 기쁘다 )
	 : Ich habe mich sehr über dein Geschenk gefreut.
	 
30. sich informieren über ( ~ 에 정보를 구하다 )
	 : Ich habe mich über den Unfall informiert.
	 
Im Sommer fahren wir in die Schweiz.
In den Alpen kann mann sich gut erholen.
Seine Handynummer kann ich mir einfach nicht merken, Sie ist viel zu lang.

Ich erinnere mich an meinen Urlaub.
Erinnerst du dich an deinen letzten

Wir freuen uns ûber das schöne Wetter.
Freut ihr euch auch darüber?

Verzeihen Sie. Ich bin fremd hier.
...
### Lektion 8. 형용사 비교급 & 최상급

```
Der Hase ist schneller als die Schildkröte.
Das Flugzeug ist das schnellste von allen Verkehrsmitteln.
...
비교급 - 원급 + er
최상급 - 원급 + st
부가어적 - 명사 앞(어미변화 함) (주의 : 최상급 - 정관사)
술어적, 부사적 - 동사 뒤(어미변화 없음)(주의 : 최상급 - am ~en)
...
부가어적 - 명사 앞(어미변화 함)
Ich habe ein billigeres Auto als du (ein billiges) hast.

술어적, 부사적 - 동사 뒤(어미변화 없음)
Mein Auto ist billiger als deins.
...
최상급 : -est ( -d, -t, -s, -ß, -sch, -x, -z )
frisch - frischer - frischest
heiß - heißer - heißest
kalt - kälter - kältest
kurz - kürzer - kürzest
laut - lauter - lautest
...
-el, -er, -en : 비교급 -> -e 탈락, -e : 비교급 -> -r 만 사용
...
hoch - höher - höchst
nah - näher - nächst
viel - mehr(어미변화x) - meist
wenig - weniger(어미변화x) - wenigst
	x		-	minder - mindest
...
wohl - besser - best
oft - öfter - öftest
hä ufig - häufiger - häufigst

부가어적
Ich kaufe mir ein teures Bild.
Mein Kollege kauft sich ein teureres.
Der Chef kauft sich das teuerste.

Katja ist eine hübsche Schülerin.
Beate ist eine hübschere Schülerin.
Andrea ist die hübscheste Schülerin.

술어적
Das Bild ist teuer.
Der Tisch ist aber teurer (als das Bild).
Das Sofa ist am teuersten.

Katja ist hübsch.
Beate ist hübscher.
Andrea ist am hübschesten.
...
A ~ (genau/eben/gerade)so + 원급 + wie --> A가 B처럼 똑같다
doppelt (zweimal)so ~ wie --> 두 배 만큼이다

나는 그녀와 나이가 (똑)같다. (술어적)
 : Ich bin so alt wie sie.
 : Ich bin (genau, eben, gerade)so alt wie sie.

레나는 그녀의 언니처럼 잘 잔다. (부사적)
 : Lena schläft so gut wie ihre Schwester.

피아는 토스텐처럼 부지런한 학생이다. (부가어적)
 : Pia ist eine so fleißige Schülerin wie Torsten.
 

우등비교
A ~ 비교급 + als B --> A는 B보다 ~하다

Berlin은 Freiburg보다 아름답지 않다.
 : Berlin ist weniger so schön als Freiburg.
 : Berlin ist nicht so schön wie Freiburg.
 : Berlin ist keine so schöne Stadt wie Freiburg.
 
너 시간이 거의 없니? 난 너 보다 시간이 더 없어.
 : Hast du wenig Zeit? Ich habe weniger Zeit als du.
 : Hast du wenig Zeit? Ich habe (auch) nicht so viel Zeit wie du.

너 돈 많지? 난 너보다 돈이 더 많아.
 : Du hast viel Geld, oder? Ich habe mehr Geld als du.
 : Du hast viel Geld, oder? Ich habe so viel Geld wie du.
 : Du hast viel Geld, oder? Du hast nicht so viel Geld wie ich.
...
일이 점점 더 고되 진다.
 : Die Arbeit wird immer härter.
 : Die Arbeit wird härter und härter.
...
- Je + 비교급 + 주어...동사, desto(umso) + 비교급 + 동사 + 주어 ...

담배를 많이 피우면 필수록 더욱 중독된다.
 : Je mehr man raucht, desto süchtiger wird man.
 
많이 먹으면 먹을수록 뚱뚱해진다.
 : Je mehr man isst, desto(umso) dicker wird man.


Mia는 좋은 학생이고, Marie는 더 훌륭하고,
Benjamin은 학급에서 가장 훌륭한 학생이다.

Mia ist eine gute Schülerin, 
Marie ist eine bessere Schülerin als Mia,
Benjamin ist der beste in der Klasse.

에베레스트산이 지구 상 가장 높은 산이다.
 : Der Mount Everest ist der höchste Berg der Erde
 

- 부정관사 (eine, einer, eines) ... + 복수의 2격 = 가장 ~한 것 중 하나

저 여선생님은 학교에서 가장 예쁜 선생님들 중 하나이다.
 : Unsere Klassenlehrerin ist eine der hübschesten Lehrerinnen
 	 an der ganzen Schule.

저 자동차는 가장 빠른 자동차들 중 하나다.
 : Das Auto ist eines der schnellsten Autos der Welt.
```

```
als oder wie ?

1. Kristin ist genauso alt wie ich.
2. Ulrichs Bruder ist viel größer als meiner.
3. Das braune Sofa ist so gemütlich(bequem) wie das gelbe.
4. Mont Blanc ist höher als die Zugspite.
5. Herr Meier ist nicht so alt wie seine Frau.
...
Tom은 빠르다. 그는 빠른 학생이다.
 : Tom ist schnell. Er ist ein schneller Schüler.
 : Tom läuft schnell. Er ist ein schnell laufender Schüler.
...
과거 : gestern, früher, damals

Gestern bin ich ins Kino gegangen.
Früher war ich sehr dick.
Damals war ich noch jung.
neulich 최근에

현재 : heute, jetzt, gerade, gleich
...
미래 : morgen, bald, später, einmal

Morgen habe ich frei.
Bald nun ist Weihnachtszeit.
Er will später Lehrer werden.
Kannst du mich einmal besuchen?
...
hier 여기, hierer 이리로, da 거기에
dort 저기에, dorthin 그리로, draußen 밖에,
drinnen 안에, -wärts ~쪽으로,
irgendwo 그 어딘가에, unterwegs 도중에

oben(위에) , unten(아래에)
links(왼쪽에) , rechts(오른쪽에)
vorn(e) (앞에) , hinten(뒤에)
nach + ~ : ~으로
von + ~ : ~서부터

앞으로 나오세요.
 : Kommen Sie bitte nach vorn(e).
...
besonders, bestimmt(확실히), ganz, gern, kaum,
leider, sehr, ungefähr (etwa), ca., vielleicht, ziemlich(꽤)

Das Wetter heute ist besonders schön.
Du kommst bestimmt, oder?
...
deshalb, deswegen, daher, darum : 그 때문에 + 동사 + 주어
dadurch : 이로 인해
nämlich : 왜냐하면 ~ 때문이다, 구체적으로(말해)
...
dennoch, trotzdem : 그럼에도 불구하고

Es schneit viel, trotzdem gehe ich spazieren.
Ich habe mich erkältet, dennoch gehe ich zur Uni.
...
시간 : wann, wie lange, bis wann, seit wann
원인 : warum, wieso(어째서)
방법 : wie, wie viel, wie alt, wie groß
장소 : wo, woher, wohin

Wann fängt der Film denn an?
Warum lernt er Deutsch?
Wie alt ist er? Er ist 24 Jahre alt.
...
immer, meistens, oft(häufig), manchmal, selten / fast, nie

Zum Frühstück trinke ich immer einen Kaffee.
Ich trinke sehr selten Kaffee.
Ich gehe oft ins Kino.
Ich bin noch nie in Deutschland.

시간의 순서 부사

zuerst - dann - danach (anschließend) (곧이어) 
- schließlich(결국) - zuletzt(맨마지막으로)

Zuerst bin ich aufgewacht.
Dann habe ich deine E-Mail gelesen.
Danach habe ich gefrühstüchkt.
Und anschließend habe ich mich gewaschen
und bin gleich zur Uni gegangen.
Um 17 Uhr bin ich nach Hause zurückgekommen.
Schließlich war ich todmüde und bin zuletzt
sehr früh ins Bett gegangen.
...
eines Tages (2격) : 어느 날
Eines Tages hat mich meine Freundin besucht.

anderer Meinung (2격) : 다른 견해를 갖다.
derselben Meinung sein : 의견이 갖다.
Sie ist anderer Meinung als ich.

- 4격 부사구 : -en(r), -e(e), -es(s) + 시간의 명사
jeden Morgen : 아침마다, jeden Tag : 매일, jede Woche : 매주
jeden Monat : 매달, jesdes Jahr : 매년, den ganzen Tag 하루종일,
(für) eine Stunde : 한 시간 동안, diese Woche : 이번 주,
letztes Jahr : 작년에, nächsten Monat : 다음 달에

im Allgemeinen : 일반적으로
zum ersten Mal : 최초로
zum letzten Mal : 최근에, 마지막으로
nach wie vor : 여전히
hin und her : 이리저리

- 부사의 위치 : (대)명사, 동사 뒤, 대명사 뒤
					  형용사 앞 / 목적어 명사 앞, 부사구 앞
					  시간 - 원인 - 방법  - 장소
Ich treffe sie morgen.
Ich besuche heute meine Oma.
Heute Morgen fahre ich mit der U-Bahn zur Schule.

- 부사의 최상급
	~st : möglichst(가능한), längst(벌써, 이미)
	~stens : bestens 매우, meistens 대개, höchstens 기껏해야
					 wenigstens 적어도 / mindestens 적어도(수),
					 spätestens 늦어도
...
```
1. 전치하
	- 격지배 : 동사의 격지배처럼 일정한 격의 (대)명사, 부사 등 앞에 놓여
					 이들을 보충어로 취함.
2. 의미 : 시간, 원인, 방법, 장소 표현
...
```
장소 전치사 (Lokale Präpositionen)

								wohin?					wo?					woher?
Genitiv											 innerhalb
														 außerhalb
														 
Dativ					nach, zu			  ab, bei,			aus, von
														 gegenüber,
														 von...aus,
														 zu Hause

Akkusativ			bis, durch,				um,
							entlang,			 um...herum
							gegen, um
...
```
Präpositionen mit Genitiv (wo?)

innerhalb					Innerhalb des Gebäudes ist
~ 이내에						 das Rauchen streng verboten.

außerhalb					Außerhalb der Stadt ist die
~ 이외에						 Miete bestimmt nicht so hoch.

Bei einem Foul außerhalb des Strafraums wird ein Freistoß gegeben. (Strafstoß : 페널티킥)
```

```
Präpositionen mit Dativ

  aus					Er kommt aus der Türkei.
(woher?)			그녀는 언제 학교에서 오니?
							: Wann kommt sie aus der Schule?
							
	von					Das Mädchen kommt vom Meer.
							내 아이는 막 놀이터에서 왔다.
							: Mein Kind kommt gerade vom Spielplatz.
							
	nach				Wohin fliegen eure Kinder in den Sommerferien?
(wohin?)			In den Sommerferien fliegen unsere Kinder nach Italien.
							왼쪽으로 가세요!
							: Fahren Sie bitte nach links!
							
	zu					Gehst du (gern) zum Tanzen? (Schwimmen, Baden)
							Wie kommt man am besten zum Bahnhof? (zur Polizei)
							Ich gehe heute zu meinem Freund.
							
	ab					고속도로가 Hannover부터 비었다.
 (wo?)				: Ab Hannover war die Autobahn frei.
 
  bei					Nümberg liegt bei München. 뉘른베르크는 뮌헨 근처에 있다.
  						그녀는 삼촌 집에 산다. : Sie wohnt bei ihrem Onkel.
  						나는 그녀 집에서 점심을 먹는다. : Ich esse bei ihr zu Mittag.
  						
  gegen				그는 내 건너편에 앉아 있다. : Er sitzt mir gegenüber.
  -über				우체국은 레스토랑 건너편에 있어요. 
  						: Die Post liegt gegenüber dem Restaurant.
  						
 von...aus		내 창문에서 나는 장터를 볼 수가 있다.
 							: Von meinem Fenster aus kann ich den Marktplatz sehen.
 	
 zu Hause			Bei mir zu Hause gibt es morgen eine Grillparty
...
Präpositionen mit Akkusativ
	...
	um					Um einen Rundtisch sitze ich.
(wo/wohin?)		Gehen wir um die Ecke. Da sieht man den Markt.

	um...				Am 01. Mai tanzt man in vielen kleinen Dörfern
	herum				um den Maibaum herum.
	
	bis					Der Zug fährt nur bis München.
(wohin?)			은행까지 얼마나 멀죠? (기차역)
							: Wie weit ist es bis zur Bank? (zum Bahnhof)
							- Es sind zu Fuß ca. 15 Minuten.
							
	durch				나는 공원을 통과해서 집으로 간다.
							: Ich gehe durch den Park nach Hause.
							
	entlang			Den Fluss entlang laufe ich immer am Sonntag.
							Fahren Sie die Straße entlang bis zu Ampel!
							
	gegen				Der Betrunkene ist gegen einen großen Baum gelaufen.

	um					Morgen früh wandern wir um den Baggersee.
...
Präp					wohin + 4격										wo + 3격
---------------------------------------------------------------------
an					Sie fährt ans Meer.						Er liegt am See.

auf					Paul legt sein Buch auf				Dein Heft liegt auf dem
						den Schreibtisch.							Kühlschrank.
						
hinter			Er stellt sein Auto						Er steht hinter der Tür.
						hinter das Hause.
						
in					Wir gehen ins Kino.						Das Geld ist in der Tasche.

neben				Ich stelle die Kommode				Neben dem Bett steht
						neben das Bett.								eine Lampe.
						
über				Bei Grün darf man über				Die Lampe hängt über
						die Straße gehen.							dem Tisch.
						
unter				Man kommt unter den Baum.			Die Tasche liegt unter
																					dem Sofa.
																					
vor					Der Lehrer geht vor						Er steht vor der Tafel.
						die Tafel.				
						
über				Ich hânge die Uhr über				Das Bild hängt über dem Sofa.
						das Sofa.
						
zwischen		Sie setzt sich zwischen				Sie sitzt zwischen den Jungen.
						die Jungen.
```
...
장소 전치사
					...
					woher										wo										wohin
			Ich komme .....				Ich bin/wohne...				Ich gehe/fahre...
------------------------------------------------------------------------
국가		aus Spanien						 in dem Iran					 in die Schweiz,
																										in den Iran
																										
대륙		aus Asien							 in Europa							nach Afrika

도시		aus Berlin						 in Berlin							nach Berlin

건물1		aus der Bank				 in der Apotheke					zum Supermarkt

건물2		aus dem Büro				 		im Büro									ins Büro

바다,호수	vom Meer							 am Meer								 ans Meer

산		von der Zugspitze			 auf der Zugspitze				auf die Zugspitze

섬,시골	von der Insel Jefu		auf der Insel						auf die Insel

장,터		vom Spielplatz					am Bahnhof							zum Bahnhof

집			von zu Hause						zu Hause								nach Hause

사람	von meiner Freundin			bei meiner Freundin			zu meiner Freundin

활동	 	vom Sport								beim Sport							zum Sport
...
1. Ich gehe zuerst ins Schlafzimmer, wenn ich nach Hause komme.
2. Ich fliege in die USA.
3. Woher kommst gerade? - Ich komme von meinen Eltern.
4. Wo bist du jetzt? - Ich bin zu Hause.
5. Ich esse heute bei Mia zu Abend. Sie hat mich eingeladen.
...
```
1. 시간의 구별 : 시간의 경과 & 시점
2. 시간 의문사에 대한 답변 : wann, seit wann, wie lange...
3. 격과 시간의 경과 및 시점에 따른 시간전치사
```

```
1. 시간의 경과와 시점 ( Zeitdauer & Zeitpunkt )
	a. 아버지는 3년 전부터 더 이상 흡연하지 않으신다.
		: Seit 3 Jahren raucht mein Vater nicht mehr.
		
	b. 아버지는 3년 전에 담배를 끊으셨다.
		: Vor 3 Jahren hat mein Vater mit dem Rauchen aufgehört.
```
...
- 경과의 의문사
für wie lange 얼마동안 (미래 기간)
wie lange 얼마나 오래
wann / ab wann (현재, 미래 : 언제부터)
bis wann 언제까지
seit wann 언제부터
...
나는 금요일 10시에 병원에 있어야 한다.
 : Ich muss am Freitag um 10 Uhr beim Arzt sein.
```

```
시간적 의미의 3,4격 지배전치사

Dat.	an/in/vor/zwischen			Frage: wann?						Wann kommt er denn?
																		 wie lange?				- Am Freitag
															
Akk.	über										Frage : wie lange?			Wie lange bist du denn hier?
			(~이상)																					 - Über eine Stunde.
			
		
													Dativ.    
an(시점)			하루시간, 요일, 날짜, 경축일, 주말
...
Ich habe am Vormittag eine Vorlesung.
Ich bin am 28.01.1972 geboren.
Was hast du am Wochenende gemacht?
An Ostern haben die Studenten keine Vorlesungen.

Im Dezember fliege ich nach Deutschland.
Heute in einer Woche schreibe ich eine Prüfung.
Das mache ich in den nächsten Woche.
In der Nacht konnte ich nicht schlafen.

Vor dem Essen wasche ich mir die Hände.

Zwischen 7.00 und 8.00 Uhr kommt mein Mann nach Hause.

über(4격) ~ 이상, ~ 에 걸쳐서
 : Die Ausbildung dauert über eine Woche.
 : Übers Wochenende erhole ich mich auf Mallorca.
 
```

```
격과 시간의 경과 및 시점에 따른 시간전치사 ( 2격 )

während		동안에		Während des Frühstücks liest er die Zeitung.

innerhalb ~이내에	Innerhalb eines Monats sollten Sie die Rechnung zahlen?

außerhalb ~이외에	Außerhalb der Hochsaison sieht man hier nur wenige Touristen.

		ab		~ 부터		Von heute an habe ich einen langen Urlaub.
(von...an)(현재,미래) Ab morgen mache ich eine Diät.

	seit		~ 이래로		Seit wann lernen Sie schon Deutsch?
						(과거)	- Seit drei Monaten (lerne ich schon Deutsch.)
	
von...bis ~부터~까지	Von 9 bis 17 Uhr arbeite ich.
										Von Montag bis Donnerstag bin ich nicht hier.
										
	bis zu		~까지		Bis zum Ende des Jahres bleibe ich Seoul.
	
```

```
격과 시간의 경과 및 시점에 따른 시간전치사 ( 3 / 4 격 )

zwischen	사이에		Zwischen dem 10 und dem 15.12. wird die Praxis renoviert.

	bei			~할 때		Beim Laufen habe ich meine Frau kennen gelernt.
									 Beim Essen sollst du bitte nicht schmatzen.
									 
	bis			~까지			Sagen Sie mir bitte bis heute Abend Bescheid
	
	an			~ 에			Wann bist du geboren?
									 Wann hast du Geburtstag? - Am 28.01
									 Am Abend trinke ich immer einen Saft.
	
	aus		~시기 에서	Es werden viele Kunstwerke aus dem 17. Jahrhundert ausgestellt.
					 부터
					 
	in		~에, 후에	In den 70er Jahren gab es in Korea nur wenige Farbfernseher.
	
 nach			~후에		Nach der Vorlesung gehe ich in die Mensa.
 
 vor			~전에		Vor der Reise freut man sich immer.
 
 gegen	~즈음에		So gegen 15.00 Uhr treffen wir uns.
 (4격)		무렵에		 Der Chef kommt erst gegen Mittag.
 
 um			~정각에		Um 21:45 Uhr fährt der Zug nach Berlin ab.
 				~년 경에		Das Schloss wurde um 1700 gebaut.
```

```
1. Er ist vor 2 Jahren nach Deutschland gekommen.
2. Seit 2 Monaten lebt er in Seoul.
